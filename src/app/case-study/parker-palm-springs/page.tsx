    ...
    <main style={{ background: "#ffffff", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", height: "70vh", minHeight: "500px", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 40px 64px" }}>
          ...
          <h1 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(40px,6vw,80px)", letterSpacing: "-0.03em", color: "#000", lineHeight: 1.0, marginBottom: "16px" }}>
            Parker Palm Springs
          </h1>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "20px", color: "rgba(0,0,0,0.6)", fontWeight: 300 }}>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 40px 80px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
        <div>
          <h2 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(28px,3vw,48px)", letterSpacing: "-0.03em", color: "#000", lineHeight: 1.0, marginBottom: "32px" }}>
            Digital marketing for <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(0,0,0,0.5)" }}>elevated luxury.</span>
          </h2>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(0,0,0,0.55)", lineHeight: 1.85, marginBottom: "24px" }}>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "80px 40px 120px", borderTop: "1px solid rgba(0,0,0,0.08)" }}>
        <h2 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(28px,3vw,52px)", letterSpacing: "-0.03em", color: "#000", marginBottom: "48px" }}>
          Channel marketing <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(0,0,0,0.5)" }}>growth.</span>
        </h2>
