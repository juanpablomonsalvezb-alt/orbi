    ...
    <main style={{ background: "#ffffff", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", height: "70vh", minHeight: "500px", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 40px 64px" }}>
          ...
          <h1 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(40px,6vw,80px)", letterSpacing: "-0.03em", color: "#000", lineHeight: 1.0, marginBottom: "16px" }}>ECS Senior Living</h1>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "20px", color: "rgba(0,0,0,0.6)", fontWeight: 300 }}>Re-envisioning a new corporate brand strategy for a century-old company</p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 40px 80px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
        <div>
          <h2 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(28px,3vw,48px)", letterSpacing: "-0.03em", color: "#000", lineHeight: 1.0, marginBottom: "32px" }}>Evolving with <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(0,0,0,0.5)" }}>the times.</span></h2>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(0,0,0,0.55)", lineHeight: 1.85, marginBottom: "24px" }}>When you're a 100 year old nonprofit organization, it's easy to stick to doing things the way they've always been done. With for-profit competition with dozens of major national outlets, ECS needed a change.</p>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(0,0,0,0.55)", lineHeight: 1.85 }}>They had 5 websites and multiple communities that acted more like individual fiefdoms rather than a cohesive organization. Creating a new brand foundation and streamlining processes with tech stacks has led to an amazing partnership with YoY growth and revenue resilience.</p>
        </div>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "80px 40px 120px", borderTop: "1px solid rgba(0,0,0,0.08)" }}>
