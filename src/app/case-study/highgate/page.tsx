    ...
    <main style={{ background: "#0a0a0a", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", height: "70vh", minHeight: "500px", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 40px 64px" }}>
          ...
          <h1 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(40px,6vw,80px)", letterSpacing: "-0.03em", color: "#fff", lineHeight: 1.0, marginBottom: "16px" }}>Highgate</h1>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "20px", color: "rgba(255,255,255,0.6)", fontWeight: 300 }}>Driving digital marketing growth with a $15B global hospitality powerhouse</p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 40px 80px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
        <div>
          <h2 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(28px,3vw,48px)", letterSpacing: "-0.03em", color: "#fff", lineHeight: 1.0, marginBottom: "32px" }}>Upgraded hotel. <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(255,255,255,0.5)" }}>Updated brand.</span></h2>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(255,255,255,0.55)", lineHeight: 1.85, marginBottom: "24px" }}>Highgate Hotels is a global home and investment management firm with properties in the US and Europe. An owner in their management portfolio had an urgent need — after a recent takeover of a much beloved Waikiki Beach hotel, they were overseeing an extensive renovation.</p>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(255,255,255,0.55)", lineHeight: 1.85 }}>The goal was upgrading the property from a three-star hotel to a four-star resort. Now, they needed a brand experience to match — with a new name, a new look, and, most importantly, the targeting of a new guest profile.</p>
        </div>
