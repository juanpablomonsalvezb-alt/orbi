    ...
    <main style={{ background: "#ffffff", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", height: "70vh", minHeight: "500px", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 40px 64px" }}>
          ...
          <h1 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(40px,6vw,80px)", letterSpacing: "-0.03em", color: "#000", lineHeight: 1.0, marginBottom: "16px" }}>Personalis</h1>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "20px", color: "rgba(0,0,0,0.6)", fontWeight: 300 }}>Scaling next-stage biotech growth into commercialization</p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 40px 80px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
        <div>
          <h2 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(28px,3vw,48px)", letterSpacing: "-0.03em", color: "#000", lineHeight: 1.0, marginBottom: "32px" }}>New audiences, <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(0,0,0,0.5)" }}>adapting brand.</span></h2>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(0,0,0,0.55)", lineHeight: 1.85, marginBottom: "24px" }}>Moving from investors and pharma to clinicians, patients, and employees changes how a website is perceived. It's no longer only about getting a good return — it's about saving lives and giving hope where there was none.</p>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "16px", color: "rgba(0,0,0,0.55)", lineHeight: 1.85 }}>Merging all five audiences into a single website was the result of an amazing partnership. Collaborating closely with the in-house marketing team, 3FO serves as the foundation for digital strategy, brand development, and asset creation.</p>
        </div>
