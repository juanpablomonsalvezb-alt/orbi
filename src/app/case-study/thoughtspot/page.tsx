    ...
    <main style={{ background: "#0a0a0a", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", height: "70vh", minHeight: "500px", display: "flex", alignItems: "flex-end", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 40px 64px" }}>
          ...
          <h1 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(40px,6vw,80px)", letterSpacing: "-0.03em", color: "#fff", lineHeight: 1.0, marginBottom: "16px" }}>ThoughtSpot</h1>
          <p style={{ fontFamily: "'Aeonik', sans-serif", fontSize: "20px", color: "rgba(255,255,255,0.6)", fontWeight: 300 }}>Powering global AI with seamlessly integrated web development</p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 40px 120px" }}>
        <h2 style={{ fontFamily: "'Aeonik', sans-serif", fontWeight: 900, fontSize: "clamp(28px,3vw,48px)", letterSpacing: "-0.03em", color: "#fff", lineHeight: 1.0, marginBottom: "32px" }}>
          Global leaders <span style={{ fontWeight: 300, fontStyle: "italic", color: "rgba(255,255,255,0.5)" }}>need help too.</span>
        </h2>
        ...
        <div style={{ marginTop: "80px", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: "rgba(255,255,255,0.06)", borderRadius: "16px", overflow: "hidden" }}>
          {[
