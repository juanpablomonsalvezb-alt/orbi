...
export default function ReferidosPage() {
  ...
  const mensajeWhatsApp = encodeURIComponent(
    `Te recomiendo Orbbi — son 7 gerentes de IA para tu negocio por $49/mes. Yo lo uso para ${empresaNombre} y es increíble. Prueba la demo gratis: ${link}`
  )
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => {
              ...
              const body = encodeURIComponent(`Hola,\n\nTe recomiendo Orbbi — son 7 gerentes de IA para tu negocio por $49/mes.\n\nPrueba la demo gratis: ${link}\n\nSaludos`)
